...
const BACKEND_LABEL_KEYS: Record<string, [string, string]> = {
  ...
  tx_hardware_gain_db: ["app.device.libiio.txHardwareGainDb", "Hardware Gain (dB)"],
  "tx hardwaregain": ["app.device.libiio.txHardwareGainDb", "Hardware Gain (dB)"],
  "tx hardware gain": ["app.device.libiio.txHardwareGainDb", "Hardware Gain (dB)"],
  "tx hardware gain (db)": ["app.device.libiio.txHardwareGainDb", "Hardware Gain (dB)"],
  ...
  rx_hardware_gain_db: ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  hardwaregain: ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  "rx hardwaregain": ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  "rx hardware gain": ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  "rx hardware gain (db)": ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  "hardware gain": ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  "hardware gain (db)": ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  "硬件增益": ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
  "硬件增益 (dB)": ["app.device.libiio.rxHardwareGainDb", "Hardware Gain (dB)"],
