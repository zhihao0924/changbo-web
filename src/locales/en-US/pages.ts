export default {
  ...
  "pages.login.brand.kicker": "Network Operations",
  "pages.login.brand.desc": "Unified access for secure private-network operations, real-time awareness, and centralized management.",
