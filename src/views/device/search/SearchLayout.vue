...
const getActiveKey = (path) => {
  switch (path) {
    case '/device/search/article':
      return '1'
    case '/device/search/project':
      return '2'
    case '/device/search/application':
      return '3'
    default:
      return '1'
  }
...
export default {
  ...
  methods: {
    handleTabChange (key) {
      ...
      switch (key) {
        case '1':
          this.$router.push('/device/search/article')
          break
        case '2':
          this.$router.push('/device/search/project')
          break
        case '3':
          this.$router.push('/device/search/application')
          break
        default:
